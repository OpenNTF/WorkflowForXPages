...
public class ActivitiRestApplication extends Application {
  ...
  protected static final Logger LOGGER = Logger.getLogger(ActivitiRestApplication.class.getName());
  ...
  public synchronized Restlet createInboundRoot() {
    Verifier verifier = new SecretVerifier() {
      ...
      public int verify(Request request, Response response){
  		// We are using Domino authentication, no need to verify request here
    	 return RESULT_VALID;
      }
    };
    authenticator = new ChallengeAuthenticator(null, true, ChallengeScheme.HTTP_COOKIE,"Activiti Realm") {
